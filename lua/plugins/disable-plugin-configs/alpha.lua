return {
 ...
 ██████  █████████████████████ ████ █████ █████ ████ ██████
        ...
        dashboard.section.buttons.val = {
            ...
            -- dashboard.button("c", "  Config", ":e C:/Users/Admin/AppData/Local/nvim/init.lua <CR>"),
            dashboard.button("u", "󱐥  Update plugins", "<cmd>Lazy update<CR>"),
            dashboard.button("w", "󱗼  Workbench", ":e C:/Users/Admin/Documents/Workbench <CR>"),
            -- dashboard.button("m", "⚠  Messages (if available)", "<cmd>messages<CR>"), -- use snacks.notifier.show_history() == <leader>n instead
